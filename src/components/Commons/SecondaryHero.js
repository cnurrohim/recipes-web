...
const SecondaryHero = () => {
  return (
    <div
      className={`grid ${gridSystems} ${gapSystems} min-h-screen gap-x-2 pl-20 pr-20 bg-neutral-800 text-slate-200`}
      style={{
    ...
    >
      ...
      <div
        className="h-full bg-contain bg-center bg-no-repeat absolute top-0 w-96 left-2/4 z-0"
        style={{
